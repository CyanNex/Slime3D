...
public:
    ...
    cButton(tElementInfo tSize, uint uiPadding, cTexture* pTexture, cTexture* pTextureWhenClicked, cFont* pFont,
            float fFontSize, glm::vec3 tTextColor);
    cButton(tElementInfo tSize, uint uiPadding, cTexture* pTexture, cTexture* pTextureWhenClicked,
            const tFontInfo& tFont);

    void Click();
};

cButton::cButton(tElementInfo tSize, uint uiPadding, cTexture* pTexture, cTexture* pTextureWhenClicked, cFont* pFont,
                 float fFontSize, glm::vec3 tTextColor)
...
cButton::cButton(tElementInfo tSize, uint uiPadding, cTexture* pTexture, cTexture* pTextureWhenClicked,
                 const tFontInfo& tFont)
